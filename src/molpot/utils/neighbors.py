...
class TorchNLNaiveNeighborList(nn.Module):
    ...
    def forward(self, inputs, outputs):
        mapping, mapping_batch, shifts_idx = torch_nl.compute_neighborlist_n2(
            cutoff=self._cutoff,
            pos = inputs['atoms'][alias.xyz],
            cell = inputs['box'][alias.cell],
            pbc = inputs['box'][alias.pbc],
            batch = inputs['atoms']['idx_m'],
