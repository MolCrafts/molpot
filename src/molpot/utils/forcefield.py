...
class ForceField:
    ...
    def get_pairstyle(self, potential: str):
        for pairstyle in self.pairstyles:
            if pairstyle.name == potential:
                return pairstyle
        return None

    def get_bondstyle(self, potential: str):
        for bondstyle in self.bondstyles:
            if bondstyle.name == potential:
                return bondstyle
        return None

    def get_atomstyle(self, potential: str):
        for atomstyle in self.atomstyles:
            if atomstyle.name == potential:
                return atomstyle
        return None

    def get_anglestyle(self, potential: str):
        for anglestyle in self.anglestyles:
            if anglestyle.name == potential:
                return anglestyle
        return None

    def get_dihedralstyle(self, potential: str):
        for dihedralstyle in self.dihedralstyles:
            if dihedralstyle.name == potential:
                return dihedralstyle
        return None
    ...
    def get_potential(self):
        ...
        potential = []
        for pairstyle in self.pairstyles:
            potential.append(pairstyle.get_potential())
        for bondstyle in self.bondstyles:
            potential.append(bondstyle.get_potential())
        for anglestyle in self.anglestyles:
            potential.append(anglestyle.get_potential())
        for dihedralstyle in self.dihedralstyles:
